...
namespace Antilatency {
	namespace TrackingAlignment {
		...
		Antilatency::InterfaceContract::ExceptionCode update(Antilatency::Math::doubleQ a, Antilatency::Math::doubleQ b, double time, Antilatency::TrackingAlignment::State& result) {
...
namespace Antilatency {
	namespace TrackingAlignment {
		/* copy and paste this to implementer
		Antilatency::InterfaceContract::ExceptionCode createTrackingAlignment(Antilatency::Math::doubleQ initialARelativeToB, double initialTimeBAheadOfA, Antilatency::TrackingAlignment::ITrackingAlignment& result) {
			return Antilatency::InterfaceContract::ExceptionCode::NotImplemented;
		}
		*/
